...
1. TECHNICAL: Focus on EMA 20/50/200 Standard (EMA 200 on D1 is crucial). SMA 100 as support/resistance. Ichimoku (14) support/resistance clean. RSI (14) Divergence H4/D1. MACD signal. CCI (20) for OB/OS.
2. FUNDAMENTAL: ECB rates, Eurozone CPI, DXY, US NFP/CPI are pillars. Watch ECB press conference carefully.
3. SENTIMENT: Evaluate market sentiment (risk-on/risk-off). EURUSD is the most liquid and clean trending pair. Watch for ECB-Fed divergence.
4. RISK CONTROL: ATR H4 40-80 pip. SL can be tight. Fibonacci 38.2%/61.8% are key levels. Weekly Pivot is very effective.
...
def get_tf_indicators(df, tf_id):
    ...
    cci = ta.cci(d['high'], d['low'], d['close'], 20).iloc[-1]
