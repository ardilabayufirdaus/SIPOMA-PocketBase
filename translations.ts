export const translations = {
  en: {
    ...
    dashboard_kpi_production_subtitle: 'Current Month Production',
    dashboard_kpi_availability_subtitle: 'Operational units vs Total',
    dashboard_kpi_downtime_subtitle: 'Open Risk/Issues',
    dashboard_kpi_project_subtitle: 'Active tasks assigned',
    system_status_title: 'System Status',
    system_status_cpu: 'CPU Load',
    system_status_memory: 'Memory',
    system_status_uptime: 'System Uptime',
    system_status_sync: 'Database Sync',
    system_status_online: 'Online',
    system_status_offline: 'Offline',
    unit_cm_title: 'CM Operations',
    unit_rkc_title: 'RKC Operations',
    unit_view_all: 'VIEW ALL',
    unit_running_normal: 'Running Normal',
    unit_stopped: 'Stopped',
    unit_no_units: 'No units found',
    unit_latest_issues: 'Latest Issues',
    unit_live_feed: 'Live Feed',
    unit_no_active_issues: 'No active issues reported.',
    unit_today: 'Today',
    ...
    ccr_realTimeAutoSave: 'Real-time Auto-Save',
    ccr_materialUsageAutoSaveMsg:
      'Material usage is calculated from counter feeder data and automatically saved every 2 seconds when there are changes.',
    ccr_materialUsage: 'Material Usage',
    ccr_cementProduction: 'Cement Production',
    ...
    failed_to_delete_profile: 'Failed to delete profile: Network or server error',
    ...
    ccr_material_usage_subtitle: 'Operational material consumption',
    ccr_information_title: 'Information',
    ccr_saving_changes: 'Automatically saving changes...',
    ccr_downtime_title: 'Operational Downtime',
    ccr_downtime_subtitle: 'Log of disturbances and maintenance',
    ccr_delete_downtime_confirm_title: 'Delete Downtime Data',
    ccr_delete_downtime_message:
      'This action cannot be undone. The following downtime data will be permanently deleted:',
    ccr_delete_downtime_warning:
      '⚠️ Make sure this data really needs to be deleted before proceeding.',
    ccr_delete_permanently: 'Delete Permanently',
    ccr_reorder_instructions_title: 'There are several ways to rearrange parameters:',
    ccr_reorder_method_drag: '1. Drag and Drop:',
    ccr_reorder_method_drag_desc: 'Drag parameters to the desired position',
    ccr_reorder_method_input: '2. Number Input:',
    ccr_reorder_method_input_desc: 'Enter the desired position number in the input box',
    ccr_reorder_method_arrow: '3. ↑/↓ Buttons:',
    ccr_reorder_method_arrow_desc: 'Use arrow buttons for one-by-one adjustments',
    ccr_reorder_method_keyboard: '4. Keyboard Shortcuts:',
    ccr_reorder_method_keyboard_up: 'Alt + ↑ : Move parameter up',
    ccr_reorder_method_keyboard_down: 'Alt + ↓ : Move parameter down',
    ccr_reorder_method_search: '5. Search:',
    ccr_reorder_method_search_desc: 'Use the search feature to find parameters quickly',
    ccr_reorder_auto_save_note:
      'Parameter order will be saved automatically when pressing the "Done" button.',
    ccr_search_parameter_placeholder: 'Search parameter...',
    ccr_no_match_search: 'No parameters match your search',
    ccr_no_parameters_available: 'No parameters available',
    done: 'Done',
    ...
    description_optional_placeholder: 'Enter profile description',
    ccr_load_profile_desc: 'Select a profile to load the parameter order.',
    ...
    error_invalid_time_format: 'Invalid time format (HH:MM)',
    error_unit_required: 'Unit is required',
    error_pic_required: 'PIC is required',
    error_problem_required: 'Problem description is required',
    error_problem_min_length: 'Problem description must be at least 10 characters',
    error_end_time_before_start: 'End time must be after or equal to start time',
    error_no_plant_units: 'No plant units available. Please configure plant units first.',
    error_no_pic_settings: 'No PIC settings available. Please configure PIC settings first.',
    time_period: 'Time Period',
    assignment: 'Assignment',
    no_pic_available: 'No PIC available',
    choose_pic: 'Choose PIC',
    details: 'Details',
    placeholder_problem_description: 'Describe the problem that occurred...',
    placeholder_action_description:
      "Describe the actions taken or click 'AI RCA' for suggestions...",
    error_loading_material_usage: 'Error loading material usage data',
    real_time: 'Real-time',
    syncing: 'Syncing...',
    operational_notes: 'Operational Notes',
    important_shift_info: 'Important shift-related information',
    placeholder_information: 'Type important information here...',
    saved: 'Saved',
    auto_save_3s: 'Automatically saved every 3 seconds',
    ccr_nav_guide_title: '🎯 CCR Table Navigation Guide',
    kb_navigation: 'Keyboard Navigation:',
    tab_next_cell: 'Move to next cell',
    shift_tab_prev_cell: 'Move to previous cell',
    arrows_navigate: 'Navigate in all directions',
    esc_exit_nav: 'Exit navigation mode',
    enter_edit_cell: 'Edit current cell',
    search_filtering: 'Search & Filtering:',
    search_filter_desc: 'Use search bar to filter parameters by name or unit',
    real_time_update: 'Real-time results update as you type',
    clear_search_reset: 'Clear search to reset filters',
    partial_matches: 'Search supports partial matches',
    data_entry_tips: 'Data Entry Tips:',
    decimal_format_tip: 'Use decimal format (e.g., 12.50)',
    auto_save_tip: 'Values are auto-saved on change',
    invalid_values_tip: 'Invalid values are highlighted in red',
    footer_calc_tip: 'Footer shows real-time calculations',
    enter_confirm_tip: 'Press Enter to confirm entry',
    error_handling_title: 'Error Handling:',
    network_retry_tip: 'Network errors show retry options',
    validation_msg_tip: 'Invalid data triggers validation messages',
    auto_recovery_tip: 'Auto-recovery for temporary connection issues',
    boundary_crash_tip: 'Error boundaries prevent app crashes',
    table_features_title: 'Table Features:',
    sticky_headers_tip: 'Sticky headers for easy reference',
    fixed_footer_tip: 'Fixed footer always visible',
    scroll_nav_tip: 'Horizontal & vertical scrolling',
    auto_stat_tip: 'Auto-calculation of statistics',
    responsive_tip: 'Responsive design for mobile devices',
    accessibility_title: 'Accessibility:',
    screen_reader_tip: 'Screen reader compatible',
    contrast_mode_tip: 'High contrast mode support',
    kb_only_tip: 'Keyboard-only navigation',
    aria_labels_tip: 'ARIA labels for all interactive elements',
    got_it: 'Got it!',
    ...
    footer: 'Footer',
    operator_name_placeholder: 'Enter operator name',
    choose_product_type: 'Choose Product Type',
    edit_operator_name: 'Edit operator name',
    fill_empty_space: 'Fill empty space',
    fill_content: 'Fill content',
    auto_save_msg: 'Automatically saving changes...',
    silo_monitoring_desc: 'Monitor silo levels and capacity',
    filter_appearance_desc: 'Customize data view as needed',
    quick_actions: 'Quick Actions',
    quick_actions_desc: 'Manage data with one click',
  },
  id: {
    // Header & Navigation
    appTitle: 'SIPOMA',
    ...
    dashboard_kpi_production_subtitle: 'Produksi Bulan Ini',
    dashboard_kpi_availability_subtitle: 'Unit operasional vs Total',
    dashboard_kpi_downtime_subtitle: 'Risiko/Isu Aktif',
    dashboard_kpi_project_subtitle: 'Tugas aktif diberikan',
    system_status_title: 'Status Sistem',
    system_status_cpu: 'Beban CPU',
    system_status_memory: 'Memori',
    system_status_uptime: 'Waktu Aktif',
    system_status_sync: 'Sinkronisasi Basis Data',
    system_status_online: 'Online',
    system_status_offline: 'Offline',
    unit_cm_title: 'Operasional CM',
    unit_rkc_title: 'Operasional RKC',
    unit_view_all: 'LIHAT SEMUA',
    unit_running_normal: 'Berjalan Normal',
    unit_stopped: 'Berhenti',
    unit_no_units: 'Unit tidak ditemukan',
    unit_latest_issues: 'Isu Terbaru',
    unit_live_feed: 'Live Feed',
    unit_no_active_issues: 'Tidak ada isu aktif yang dilaporkan.',
    unit_today: 'Hari Ini',
    ...
    op_monitoring: 'Monitoring',
    ccr_realTimeAutoSave: 'Penyimpanan Otomatis Real-time',
    ccr_materialUsageAutoSaveMsg:
      'Material usage dihitung dari counter feeder data dan otomatis tersimpan setiap 2 detik ketika ada perubahan.',
    ccr_materialUsage: 'Penggunaan Material',
    ccr_cementProduction: 'Produksi Semen',
    ...
    ccr_material_usage_subtitle: 'Konsumsi material operasional',
    ccr_information_title: 'Informasi',
    ccr_saving_changes: 'Otomatis menyimpan perubahan...',
    ccr_downtime_title: 'Downtime Operasional',
    ccr_downtime_subtitle: 'Log gangguan dan pemeliharaan',
    ccr_delete_downtime_confirm_title: 'Hapus Data Downtime',
    ccr_delete_downtime_message:
    ...
    ccr_delete_permanently: 'Hapus Permanen',
    ccr_reorder_instructions_title: 'Ada beberapa cara untuk menyusun ulang parameter:',
    ccr_reorder_method_drag: '1. Drag and Drop:',
    ccr_reorder_method_drag_desc: 'Tarik parameter ke posisi yang diinginkan',
    ccr_reorder_method_input: '2. Input Nomor:',
    ccr_reorder_method_input_desc: 'Masukkan nomor posisi yang diinginkan pada kotak input',
    ccr_reorder_method_arrow: '3. Tombol ↑/↓:',
    ccr_reorder_method_arrow_desc: 'Gunakan tombol panah untuk penyesuaian satu per satu',
    ccr_reorder_method_keyboard: '4. Pintasan Keyboard:',
    ccr_reorder_method_keyboard_up: 'Alt + ↑ : Pindahkan parameter ke atas',
    ccr_reorder_method_keyboard_down: 'Alt + ↓ : Pindahkan parameter ke bawah',
    ccr_reorder_method_search: '5. Pencarian:',
    ccr_reorder_method_search_desc:
    ...
    ccr_search_parameter_placeholder: 'Cari parameter...',
    ccr_no_match_search: 'Tidak ada parameter yang cocok dengan pencarian',
    ccr_no_parameters_available: 'Tidak ada parameter yang tersedia',
    done: 'Selesai',
    ccr_save_profile_desc:
      'Simpan urutan parameter saat ini sebagai profil yang dapat dimuat nanti.',
    profile_name_label: 'Nama Profil *',
    profile_name_placeholder: 'Masukkan nama profil',
    description_optional_label: 'Deskripsi (opsional)',
    description_optional_placeholder: 'Masukkan deskripsi profil',
    ccr_load_profile_desc: 'Pilih profil untuk memuat urutan parameter.',
    no_profiles_available: 'Tidak ada profil yang tersedia',
    created_by: 'Dibuat oleh',
    you: 'Anda',
    another_user: 'User lain',
    load: 'Muat',
    ccr_delete_profile_confirm_message:
      'Apakah Anda yakin ingin menghapus profil "{name}"? Tindakan ini tidak dapat dibatalkan.',
    ...
    error_time_required: 'Waktu wajib diisi',
    error_invalid_time_format: 'Format waktu tidak valid (JJ:MM)',
    error_unit_required: 'Unit wajib diisi',
    error_pic_required: 'PIC wajib diisi',
    error_problem_required: 'Deskripsi masalah wajib diisi',
    error_problem_min_length: 'Deskripsi masalah harus minimal 10 karakter',
    error_end_time_before_start: 'Waktu selesai harus setelah atau sama dengan waktu mulai',
    error_no_plant_units:
      'Tidak ada unit pabrik tersedia. Silakan konfigurasi unit pabrik terlebih dahulu.',
    error_no_pic_settings:
      'Tidak ada pengaturan PIC tersedia. Silakan konfigurasi pengaturan PIC terlebih dahulu.',
    time_period: 'Periode Waktu',
    assignment: 'Penugasan',
    no_pic_available: 'Tidak ada PIC tersedia',
    choose_pic: 'Pilih PIC',
    details: 'Detail',
    placeholder_problem_description: 'Jelaskan masalah yang terjadi...',
    placeholder_action_description:
      "Jelaskan tindakan yang diambil atau klik 'AI RCA' untuk saran...",
    error_loading_material_usage: 'Gagal memuat data penggunaan material',
    real_time: 'Real-time',
    syncing: 'Sinkronisasi...',
    operational_notes: 'Catatan Operasional',
    important_shift_info: 'Informasi penting terkait shift',
    saving: 'Menyimpan...',
    placeholder_information: 'Ketik informasi penting di sini...',
    saved: 'Tersimpan',
    auto_save_3s: 'Disimpan otomatis setiap 3 detik',
    ccr_nav_guide_title: '🎯 Panduan Navigasi Tabel CCR',
    kb_navigation: 'Navigasi Keyboard:',
    tab_next_cell: 'Pindah ke sel berikutnya',
    shift_tab_prev_cell: 'Pindah ke sel sebelumnya',
    arrows_navigate: 'Navigasi ke segala arah',
    esc_exit_nav: 'Keluar dari mode navigasi',
    enter_edit_cell: 'Edit sel saat ini',
    search_filtering: 'Pencarian & Filter:',
    search_filter_desc:
      'Gunakan bilah pencarian untuk menyaring parameter berdasarkan nama atau unit',
    real_time_update: 'Hasil diperbarui secara real-time saat Anda mengetik',
    clear_search_reset: 'Hapus pencarian untuk mengatur ulang filter',
    partial_matches: 'Pencarian mendukung pencocokan sebagian',
    data_entry_tips: 'Tips Entri Data:',
    decimal_format_tip: 'Gunakan format desimal (contoh: 12.50)',
    auto_save_tip: 'Nilai disimpan otomatis saat terjadi perubahan',
    invalid_values_tip: 'Nilai tidak valid akan disorot warna merah',
    footer_calc_tip: 'Footer menampilkan perhitungan real-time',
    enter_confirm_tip: 'Tekan Enter untuk mengonfirmasi entri',
    error_handling_title: 'Penanganan Kesalahan:',
    network_retry_tip: 'Kesalahan jaringan menampilkan opsi coba lagi',
    validation_msg_tip: 'Data tidak valid memicu pesan validasi',
    auto_recovery_tip: 'Pemulihan otomatis untuk masalah koneksi sementara',
    boundary_crash_tip: 'Error boundaries mencegah aplikasi crash',
    table_features_title: 'Fitur Tabel:',
    sticky_headers_tip: 'Header tetap (sticky) untuk referensi mudah',
    fixed_footer_tip: 'Footer tetap yang selalu terlihat',
    scroll_nav_tip: 'Gulir horizontal & vertikal',
    auto_stat_tip: 'Penghitungan statistik otomatis',
    responsive_tip: 'Desain responsif untuk perangkat seluler',
    accessibility_title: 'Aksesibilitas:',
    screen_reader_tip: 'Kompatibel dengan pembaca layar',
    contrast_mode_tip: 'Dukungan mode kontras tinggi',
    kb_only_tip: 'Navigasi hanya keyboard',
    aria_labels_tip: 'Label ARIA untuk semua elemen interaktif',
    got_it: 'Mengerti!',
    refresh_data: 'Perbarui Data',
    updated_at_label: 'Terakhir diperbarui:',
    hide_footer: 'Sembunyikan Footer',
    show_footer: 'Tampilkan Footer',
    reorder: 'Susun Ulang',
    import: 'Impor',
    template: 'Templat',
    export: 'Ekspor',
    delete_data: 'Hapus Data',
    delete_names: 'Hapus Nama',
    footer: 'Footer',
    operator_name_placeholder: 'Masukkan nama operator',
    choose_product_type: 'Pilih Tipe Produk',
    edit_operator_name: 'Ubah nama operator',
    fill_empty_space: 'Isi ruang kosong',
    fill_content: 'Isi konten',
    auto_save_msg: 'Otomatis menyimpan perubahan...',
    silo_monitoring_desc: 'Monitoring level dan kapasitas silo',
    filter_appearance_desc: 'Sesuaikan tampilan data yang diperlukan',
    quick_actions: 'Aksi Cepat',
    quick_actions_desc: 'Kelola data dengan satu klik',
  },
};
