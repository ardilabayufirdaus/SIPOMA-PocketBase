    ...
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900 backdrop-blur-3xl font-sans">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="ml-8 flex items-center gap-4 bg-white/50 dark:bg-slate-800/50 px-6 py-2.5 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm backdrop-blur-sm">
            ...
            <select
              ...
              className="bg-transparent border-none text-sm font-bold text-slate-800 dark:text-white focus:ring-0 outline-none cursor-pointer p-0 pr-8"
            >
      ...
      <form onSubmit={handleSubmit} className="flex-1 overflow-hidden flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((s) => {
              ...
              return (
                ...
                >
                  <div className="absolute top-0 right-0 p-12 bg-primary-600/5 rounded-full -mr-8 -mt-8 group-hover:bg-primary-600/10 transition-colors"></div>
                    ...
                    <button
                      ...
                      className={`px-5 py-2 rounded-xl text-[10px] font-bold transition-all duration-300 ${
                        isAssigned
                          ...
                          : 'bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-300 hover:bg-primary-600 hover:text-white hover:shadow-lg hover:shadow-emerald-500/20'
                      }`}
                    >
                  ...
                  <div className="space-y-4 relative z-10">
                    <div>
                      ...
                      <div className="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-2xl text-sm font-bold text-slate-800 dark:text-white flex items-center shadow-inner">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className={`w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-2xl text-sm font-bold text-slate-800 dark:text-white outline-none focus:ring-2 ring-primary-500/20 focus:border-primary-500 transition-all appearance-none shadow-inner ${
                    ...
                    {group.equipments.map((eq, eIdx) => (
                      <React.Fragment key={eq.id}>
                        <tr className="bg-white dark:bg-slate-900 group/eq border-b border-slate-50 dark:border-white/5">
                          ...
                          <td
                            className="px-6 py-4 font-bold text-slate-800 dark:text-white group-hover/eq:text-primary-600 transition-colors"
                            colSpan={5}
                          >
                            {eq.name}
                          </td>
                        ...
                        {eq.checkPoints.map((cp) => (
                          ...
                          >
                            ...
                            <td className="px-2 py-3">
                              <input
                                placeholder="Status"
                                className="w-full px-3 py-2.5 text-center bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-white/10 rounded-xl focus:ring-2 ring-primary-500/20 focus:bg-white dark:focus:bg-slate-900 focus:border-primary-500 outline-none text-xs font-bold transition-all shadow-inner text-slate-800 dark:text-white"
                              ...
                              <input
                                ...
                                className={`w-full px-5 py-2.5 bg-slate-50 dark:bg-slate-800 border rounded-xl focus:ring-2 outline-none text-xs transition-all shadow-inner ${
                                  reportData[cp.id]?.note
                                    ...
                                    : 'border-slate-200 dark:border-white/10 text-slate-500 italic focus:ring-primary-500/20 focus:border-primary-500 group-hover/row:bg-white dark:group-hover/row:bg-slate-900 font-medium'
                                }`}
        ...
        <div className="p-8 border-t border-slate-200 dark:border-white/10 flex gap-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md">
          ...
          <button
            type="submit"
            className="flex-[2] py-4 bg-gradient-to-r from-primary-600 to-emerald-600 hover:from-primary-700 hover:to-emerald-700 text-white rounded-xl font-bold uppercase tracking-[0.2em] transition-all shadow-xl shadow-emerald-500/30 hover:shadow-emerald-500/50 active:scale-[0.98]"
          >
            Submit Daily Report
          </button>
        </div>
