      ...
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {roles.map((role) => (
              ...
              >
                ...
                <div className="text-xs text-gray-500 mt-1">Default permissions</div>
              </button>
            ))}
          </div>
        </div>
        ...
        <EnhancedCard className="p-6">
          ...
          {isLoadingPermissions ? (
              ...
              {modules.map((module) => (
                ...
                >
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-500">Module access level</div>
                  </div>
            ...
            <div className="text-center py-8 text-gray-500">Failed to load permissions</div>
          )}
        </EnhancedCard>
