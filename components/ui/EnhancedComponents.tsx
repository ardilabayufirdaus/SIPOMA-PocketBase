      ...
      {label && (
        <label
          className={cn(
            ...
            !error && !success && !warning && 'text-neutral-700'
          )}
        >
          {label}
...
export const EnhancedModal: React.FC<EnhancedModalProps> = ({
  ...
  const variantClasses = {
    ...
    minimal: 'bg-white border border-neutral-200',
  };
      ...
      >
        ...
        {title && (
          <div className="flex items-center justify-between p-6 border-b border-neutral-200">
            ...
            <button
              onClick={onClose}
              className="p-2 text-neutral-400 hover:text-neutral-600 transition-colors duration-200 rounded-lg hover:bg-neutral-100"
            >
...
export const GestaltContainer: React.FC<{
  ...
  const principleClasses = {
    ...
    similarity: 'divide-y divide-neutral-200', // Similar items with dividers
    closure: 'rounded-lg border border-neutral-200 p-4', // Complete the shape
    continuity: 'flex flex-col space-y-2', // Guide the eye smoothly
    'figure-ground': 'bg-neutral-50 p-4 rounded-lg', // Clear foreground/background
  };
  ...
  return (
    <div className={className}>
      <button
        ...
        onClick={onToggle}
        className="flex items-center justify-between w-full p-4 text-left bg-neutral-50 rounded-lg hover:bg-neutral-100 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500"
      >
        {trigger}
        <svg
