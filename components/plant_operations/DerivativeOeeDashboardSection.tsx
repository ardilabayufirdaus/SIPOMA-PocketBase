    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2">
          ...
          Derivative OEE Performance Leaderboard
        </h3>
        <button
      ...
      <div className="relative group">
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 via-teal-600 to-indigo-600 rounded-[3rem] blur-2xl opacity-10 group-hover:opacity-20 transition-opacity duration-700" />
        <div className="relative bg-white/40 backdrop-blur-3xl p-1 rounded-[3rem] border border-white/60 shadow-2xl shadow-slate-200/50">
          <div className="bg-gradient-to-br from-white/80 to-white/40 p-6 md:p-10 rounded-[2.8rem] flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10 text-center md:text-left">
              <div className="w-16 h-16 md:w-24 md:h-24 rounded-[1.5rem] md:rounded-[2rem] bg-gradient-to-br from-emerald-600 to-teal-500 flex items-center justify-center shadow-2xl shadow-emerald-200 relative overflow-hidden flex-shrink-0">
                <div className="absolute inset-0 bg-white/20 animate-pulse" />
                <TrendingUp className="w-8 h-8 md:w-12 md:h-12 text-white relative z-10" />
              </div>
              <div>
                <span className="text-[9px] md:text-[11px] font-black text-emerald-600 uppercase tracking-[0.4em] mb-1 md:mb-2 block">
                ...
                <div className="flex items-end justify-center md:justify-start gap-1 md:gap-3">
                  ...
                  <span className="text-xl md:text-3xl font-black text-emerald-600 mb-0.5 md:mb-1">
                    %
                  </span>
                </div>
              </div>
            ...
            <div className="flex flex-col items-center md:items-end gap-3 md:gap-4 text-center md:text-right">
              ...
              <p className="max-w-[300px] text-[10px] md:text-xs text-slate-400 font-medium leading-relaxed italic opacity-80 hidden md:block">
                ...
                design capacity and availability data for Derivative operations.
              </p>
            </div>
          </div>
        </div>
