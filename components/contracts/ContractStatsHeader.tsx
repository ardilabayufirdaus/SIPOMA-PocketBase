  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
      ...
      <motion.div
        ...
        className={`cursor-pointer rounded-xl p-3 sm:p-3.5 border transition-all duration-200 shadow-xs relative h-full flex flex-col justify-between ${
          activeFilter === 'all'
      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-950/80 border border-blue-200 dark:border-blue-800 flex items-center justify-center text-blue-600 dark:text-blue-400 shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-baseline gap-2 mt-0.5">
              <h3 className="text-lg sm:text-xl font-black font-mono text-slate-900 dark:text-white tracking-tight">
                {stats.totalContracts}
              </h3>
              <span className="text-[10px] font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/80 px-1.5 py-0.2 rounded border border-emerald-200 dark:border-emerald-800">
        ...
        <div className="mt-2.5 pt-2 border-t border-slate-100 dark:border-slate-800/80">
          <div className="flex justify-between items-center text-[10px] font-bold mb-1">
            ...
            <span className="text-blue-600 dark:text-blue-400 ml-1 shrink-0 font-mono">
      ...
      <motion.div
        whileHover={{ y: -1 }}
        transition={{ duration: 0.2 }}
        className="rounded-xl p-3 sm:p-3.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs h-full flex flex-col justify-between"
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <h3 className="text-lg sm:text-xl font-black font-mono text-slate-900 dark:text-white tracking-tight truncate mt-0.5">
              ...
              <div className="flex items-center gap-1 flex-wrap mt-1">
                {foreignCurrencies.map((fc) => {
                  ...
                  return (
                    <span
                      key={fc}
                      className="inline-flex items-center gap-1 px-1 py-0.2 rounded bg-slate-100 dark:bg-slate-800 text-[9px] font-mono font-bold text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700"
                    >
                      <span>{fc}:</span>
        ...
        <div className="mt-2.5 pt-2 border-t border-slate-100 dark:border-slate-800/80">
          <div className="flex justify-between items-center text-[10px] font-bold mb-1">
            ...
            <span className="text-emerald-600 dark:text-emerald-400 ml-1 shrink-0 font-mono">
      ...
      <motion.div
        ...
        className={`cursor-pointer rounded-xl p-3 sm:p-3.5 border transition-all duration-200 shadow-xs relative overflow-hidden h-full flex flex-col justify-between ${
          activeFilter === 'h90'
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[10px] font-bold text-amber-800 dark:text-amber-400 uppercase tracking-wider truncate">
              {t.h90_expiring_count || 'Peringatan H-90'}
            </p>
            <div className="flex items-baseline gap-2 mt-0.5">
              <h3 className="text-lg sm:text-xl font-black font-mono text-amber-600 dark:text-amber-400 tracking-tight">
                {stats.h90ExpiringContracts}
              </h3>
              <span className="text-[10px] font-bold text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/80 px-1.5 py-0.2 rounded border border-amber-200 dark:border-amber-800">
                &lt;90 {t.days_left || 'hari'}
              </span>
            </div>
          </div>
        ...
        <div className="mt-2.5 pt-2 border-t border-slate-100 dark:border-slate-800/80">
          <div className="flex justify-between items-center text-[10px] font-bold mb-1">
            ...
            <span className="text-amber-600 dark:text-amber-400 ml-1 shrink-0 font-mono">
      ...
      <motion.div
        ...
        className={`cursor-pointer rounded-xl p-3 sm:p-3.5 border transition-all duration-200 shadow-xs h-full flex flex-col justify-between ${
      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-rose-50 dark:bg-rose-950/80 border border-rose-200 dark:border-rose-800 flex items-center justify-center text-rose-600 dark:text-rose-400 shrink-0">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-baseline gap-2 mt-0.5">
              <h3 className="text-lg sm:text-xl font-black font-mono text-rose-600 dark:text-rose-400 tracking-tight">
                {stats.expiredContracts}
              </h3>
              <span className="text-[10px] font-semibold text-rose-700 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/80 px-1.5 py-0.2 rounded border border-rose-200 dark:border-rose-800">
        ...
        <div className="mt-2.5 pt-2 border-t border-slate-100 dark:border-slate-800/80">
          <div className="flex justify-between items-center text-[10px] font-bold mb-1">
            ...
            <span className="text-rose-600 dark:text-rose-400 ml-1 shrink-0 font-mono">
