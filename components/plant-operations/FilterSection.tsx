    ...
    <div className="bg-white/80 backdrop-blur-md rounded-xl shadow-md border border-slate-200/60 p-5">
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary-600 to-emerald-600 flex items-center justify-center shadow-md">
        ...
        <div className="flex flex-wrap items-end gap-4">
          ...
          <div className="flex-1 min-w-[180px]">
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-primary-500/40 focus:border-primary-500 text-sm font-medium transition-all duration-200 hover:border-slate-300 cursor-pointer"
              >
          ...
          <div className="flex-1 min-w-[150px]">
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-primary-500/40 focus:border-primary-500 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed text-sm font-medium transition-all duration-200 hover:border-slate-300 cursor-pointer"
              >
          ...
          {onReset && activeFiltersCount > 0 && (
            <EnhancedButton
              ...
              onClick={handleReset}
              disabled={isLoading}
              className="whitespace-nowrap px-4 py-2.5 h-auto border-slate-300 hover:border-primary-600 hover:text-primary-600 transition-all duration-200"
            >
