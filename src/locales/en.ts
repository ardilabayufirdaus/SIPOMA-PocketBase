const en = {
  ...
  dashboard_welcome_message: 'OPERATIONAL SYSTEM • READY FOR PRODUCTION',
  guest_role: 'Guest',
  users_online: 'Online',

  // Main Dashboard - KPI Section
  dashboard_total_production: 'Total Cement Production',
  dashboard_kpi_production_subtitle: 'Current Month Production',
  dashboard_availability: 'Plant Availability',
  dashboard_kpi_availability_subtitle: 'Operational Unit Readiness',
  dashboard_critical_downtime: 'Active Downtime',
  dashboard_kpi_downtime_subtitle: 'Open Issues / Risks',
  dashboard_pending_projects: 'Ongoing Projects',
  dashboard_kpi_project_subtitle: 'Active Tasks / Projects',
  ...
  ai_review_title: 'AI Operational Review',
  ai_badge_intelligence: 'INTELLIGENCE',
  ai_kpi_prod: 'Prod:',
  ai_kpi_downtime: 'Downtime:',
  ai_kpi_efficiency: 'Efficiency:',
  ai_unit_prev: 'Previous Unit',
  ai_unit_next: 'Next Unit',
  ai_close_detail: 'Close Details',
  ai_open_analysis: 'Open Analysis',
  ai_review_result: 'Operational Analysis Results',
  ai_recommendations: 'Strategic Action Recommendations',

  // Main Dashboard - Production & Material Mix Chart
  chart_production_title: 'Production Trends & Material Mix',
  chart_production_sub: 'Raw material usage aggregation and total cement production',
  chart_range_7d: '7 Days',
  chart_range_14d: '14 Days',
  chart_total_production: 'Total Production',
  mat_clinker: 'Clinker',
  ...
  mat_fly_ash: 'Fly Ash',
  mat_ckd: 'CKD / Others',
  chart_y_axis_title: 'Production Volume & Materials (Tons)',
  chart_no_material_data: 'No production material data available',

  // Main Dashboard - Silo Occupancy
  silo_occupancy_title: 'Cement Silo Stock Levels',
  silo_occupancy_sub: 'Capacity & stock availability across all Silos',
  silo_filter_unit: 'Filter Silo Unit',
  silo_all_units: 'All Units',
  silo_view_vector: 'Silo Vector View',
  silo_view_list: 'Silo List View',
  silo_total_occupancy: 'Total Occupancy Rate',
  silo_stock: 'Stock:',
  silo_capacity: 'Capacity:',
  silo_no_data: 'No silo data for this unit',
  silo_status_crit_full: 'Critically Full',
  silo_status_high: 'High',
  silo_status_crit_low: 'Critically Low',
  silo_status_normal: 'Normal',
  silo_remaining: 'Rem.:',
  silo_max: 'Max:',

  // Main Dashboard - Downtime Pareto Analysis
  chart_pareto_title: 'Downtime Pareto Analysis',
  chart_pareto_sub: 'Operational shutdown causes contribution analysis',
  chart_pareto_duration: 'Duration (Minutes)',
  chart_pareto_frequency: 'Frequency',
  chart_pareto_no_data: 'No downtime data for this period',
  chart_pareto_bar_duration: 'Downtime Duration (Minutes)',
  chart_pareto_bar_frequency: 'Occurrence Frequency (Times)',
  chart_pareto_line_cum: 'Cumulative Contribution (%)',
  chart_pareto_y_duration: 'Duration (Minutes)',
  chart_pareto_y_frequency: 'Frequency (Times)',
  chart_pareto_y_cum: 'Cumulative %',

  // Main Dashboard - Operations Overview
  unit_cm_title: 'CM Operations',
  unit_rkc_title: 'RKC Operations',
  unit_view_all: 'VIEW ALL',
  unit_latest_issues: 'Latest Issues (Downtime)',
  unit_live_feed: 'Live Feed',
  unit_today: 'Today',
  unit_stopped: 'Shutdown Detected',
  unit_running_normal: 'Normal Operation',
  unit_no_units: 'No units found',
  unit_no_active_issues: 'No active downtime issues.',
  unit_status_run: 'RUN',
  ...
  cop_parameter_subtitle: 'Critical operating parameters selection',
  ...
  trass_material_storage_subtitle:
    'Stock and filled space recording for Material Storage Warehouse',
  trass_material_storage_header: 'Material Storage',
  no_trass_storage_data: 'No Material Storage data for category',
  ruang_isi: 'Filled Space (m)',

  // WhatsApp Group Report - Derivative
  wag_derivative_title: 'WhatsApp Group Report — Derivative Plant',
  wag_derivative_subtitle:
    'Generate and format daily operational reports for Derivative Plant WhatsApp Group',
  wag_report_date: 'Report Date',
  wag_select_unit: 'Select Unit',
  wag_select_unit_placeholder: 'Select units...',
  wag_units_selected: 'Units Selected',
  wag_select_all: 'SELECT ALL',
  wag_clear_all: 'CLEAR ALL',
  wag_processing_report: 'Processing Report...',
  wag_generate_button: 'Generate WhatsApp Report',
  wag_preview_title: 'Preview WhatsApp Chat Bubble',
  wag_copy_text: 'Copy Text',
  wag_copied_text: 'Copied!',
  wag_open_web: 'Open WhatsApp Web',
  ...
  importing_excel: 'Importing...',
  export_excel: 'Export Excel',
  exporting_excel: 'Exporting...',
  ...
  click_generate_report: 'Click GENERATE LOG SHEET to view report',
  configure_master_data_hint: 'Please configure parameters in Plant Operations - Master Data.',
  ...
  no_projects_message: 'No projects have been registered in the system yet.',
  no_results_found: 'No Results Found',
  no_results_message: 'No projects match the search keyword or selected filter.',
  ...
  project_overview_subtitle: 'Real-time insights and progress tracking',
  project_tasks: 'Project Tasks',
  project_tasks_list: 'Project Tasks List',
  proj_duration: 'Project Duration',
  proj_total_tasks: 'Total Tasks',
  proj_budget: 'Budget',
  project_budget: 'Budget',
  s_curve_chart_title: 'S-Curve Chart',
  s_curve_view: 'S-Curve',
  ...
  behind_of_schedule: 'Behind Schedule',
  on_track_schedule: 'On Track',
  ...
  get_started_by_creating_a_task: 'Get started by creating your first task for this project.',
  ...
  project_performance_list: 'Project Performance List',
  health_score: 'Health Score',
  baseline_progress: 'Baseline',
  export_error_no_tasks: 'No tasks to export',
  export_failed: 'Failed to export task data. Please try again.',
  // Project Dashboard
  ...
  contract_sla_sub:
    'Monitoring SAP Purchase Orders, H-90 contract expiry, budget & volume realization, and digital document repository.',
  ...
  budget_absorbed: 'Absorbed Budget',
  budget_remaining: 'Remaining Budget',
  contract_volume: 'Contract Volume',
  absorbed_volume: 'Absorbed Volume',
  remaining_volume: 'Remaining Volume',
  volume_unit: 'Volume Unit',
  pic_name: 'PIC / Supervisor Name',
  pic_contact: 'PIC Contact / WhatsApp',
  sap_screenshot: 'SAP PO Screenshot',
  contract_pdf: 'Contract PDF Document',
  attachments: 'PDF Attachments',
  sla_kpi_target: 'SLA & KPI Targets',
  sla_status: 'SLA Status',
  notes: 'Notes / Remarks',
  h90_warning_badge: 'Expiring Soon (H-90)',
  h30_critical_badge: 'Critical (H-30)',
  active_badge: 'Active',
  expired_badge: 'Expired',
  add_contract: 'Add New Contract',
  edit_contract: 'Edit Contract',
  delete_contract: 'Delete Contract',
  contract_detail: 'Contract & SLA Details',
  total_contracts: 'Total Contracts',
  active_contracts: 'Active Contracts',
  h90_expiring_count: 'H-90 Expiry Alert',
  expired_contracts: 'Expired Contracts',
  total_managed_budget: 'Contract Budget',
  overall_absorption: 'Total Budget Absorption',
  absorbed: 'Absorbed',
  remaining: 'Remaining',
  ...
  expired: 'Expired',
  search_contract_placeholder: 'Search PO number, contract title, or vendor...',
  all_categories: 'All Categories',
  sort_by: 'Sort by',
  sort_created_desc: 'Recently Added',
  sort_expiry_asc: 'Expiring Soonest',
  sort_budget_desc: 'Highest Budget',
  sort_title_asc: 'Contract Title (A-Z)',
  export_csv: 'Export CSV',
  reset_filters: 'Reset All Filters',
  no_contracts_found: 'No contracts match the current filters',
  no_contracts_desc: 'Please modify your search keyword or reset filters to view other contracts.',
  preview_pdf: 'View PDF',
  preview_sap: 'View SAP',
  ...
  delete_confirm_title: 'Delete Contract Data?',
  delete_confirm_desc:
    'Are you sure you want to delete this contract? This action cannot be undone.',
  update_realization: 'Update Realization',
  update_realization_title: 'Update Budget & Volume Realization',
  copied_to_clipboard: 'PO number copied to clipboard',
  h90_alert_banner_title: 'Notice: Contracts Approaching Expiry (H-90 / H-30)',
  view_all_h90: 'View All H-90',
  contract_info_tab: 'Main Info',
  contract_budget_tab: 'Budget & Volume',
  contract_docs_tab: 'Files & Attachments',
  contract_sla_tab: 'SLA Target & PIC',
  upload_contract_pdf: 'Upload Contract Document (PDF)',
  upload_sap_screenshot: 'Upload SAP PO Screenshot (Image)',
  upload_attachments: 'Upload Attachment Documents (Multi PDF)',
  drag_drop_pdf: 'Drag & drop Contract PDF file here, or click to browse',
  drag_drop_image: 'Drag & drop SAP PO Screenshot here, or click to browse',
  drag_drop_attachments: 'Drag & drop additional attachment files here, or click to browse',
  drop_files_here: 'Drop files here...',
  click_to_browse: 'Browse Files',
  no_attachments: 'No document attachments uploaded',
  no_pdf_uploaded: 'No PDF document uploaded',
  no_sap_uploaded: 'No SAP screenshot uploaded',
  fill_required_fields: 'Please fill in all required fields (*)',
  need_renewal: 'Needs Renewal',
  all_secure: 'All Secure',
  no_expired: 'No expired contracts',
