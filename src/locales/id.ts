const id = {
  ...
  // Main Dashboard - Greetings & Header
  greeting_morning: 'Selamat Pagi',
  greeting_afternoon: 'Selamat Siang',
  greeting_evening: 'Selamat Sore',
  greeting_night: 'Selamat Malam',
  dashboard_welcome_message: 'SISTEM OPERASIONAL • SIAP UNTUK PRODUKSI',
  guest_role: 'Tamu',
  users_online: 'Online',

  // Main Dashboard - KPI Section
  dashboard_total_production: 'Total Produksi Semen',
  dashboard_kpi_production_subtitle: 'Produksi Bulan Berjalan',
  dashboard_availability: 'Kesiapan Pabrik',
  dashboard_kpi_availability_subtitle: 'Kesiapan Unit Operasional',
  dashboard_critical_downtime: 'Downtime Aktif',
  dashboard_kpi_downtime_subtitle: 'Isu / Risiko Terbuka',
  dashboard_pending_projects: 'Proyek Berjalan',
  dashboard_kpi_project_subtitle: 'Tugas / Proyek Berjalan',
  ...
  // Main Dashboard - AI Operational Review
  ai_review_title: 'Tinjauan Operasional AI',
  ai_badge_intelligence: 'INTELLIGENCE',
  ai_kpi_prod: 'Prod:',
  ai_kpi_downtime: 'Downtime:',
  ai_kpi_efficiency: 'Efisiensi:',
  ai_unit_prev: 'Unit Sebelumnya',
  ai_unit_next: 'Unit Berikutnya',
  ai_close_detail: 'Tutup Detail',
  ai_open_analysis: 'Buka Analisis',
  ai_review_result: 'Hasil Analisis Operasional',
  ai_recommendations: 'Rekomendasi Tindakan Strategis',

  // Main Dashboard - Production & Material Mix Chart
  chart_production_title: 'Tren Produksi & Mix Material',
  chart_production_sub: 'Agregasi penggunaan bahan baku dan total produksi semen',
  chart_range_7d: '7 Hari',
  chart_range_14d: '14 Hari',
  chart_total_production: 'Total Produksi',
  mat_clinker: 'Klinker',
  mat_limestone: 'Batu Kapur',
  mat_gypsum: 'Gipsum',
  mat_trass: 'Trass',
  mat_fly_ash: 'Fly Ash',
  mat_ckd: 'CKD / Lainnya',
  chart_y_axis_title: 'Volume Produksi & Material (Ton)',
  chart_no_material_data: 'Belum ada data material produksi',

  // Main Dashboard - Silo Occupancy
  silo_occupancy_title: 'Level Stok Silo Semen',
  silo_occupancy_sub: 'Kapasitas & ketersediaan stok di seluruh Silo',
  silo_filter_unit: 'Filter Unit Silo',
  silo_all_units: 'Semua Unit',
  silo_view_vector: 'Tampilan Vektor Silo',
  silo_view_list: 'Tampilan List Silo',
  silo_total_occupancy: 'Total Occupancy Rate',
  silo_stock: 'Stok:',
  silo_capacity: 'Kapasitas:',
  silo_no_data: 'Tidak ada data silo untuk unit ini',
  silo_status_crit_full: 'Kritis Penuh',
  silo_status_high: 'Tinggi',
  silo_status_crit_low: 'Kritis Rendah',
  silo_status_normal: 'Normal',
  silo_remaining: 'Sisa:',
  silo_max: 'Max:',

  // Main Dashboard - Downtime Pareto Analysis
  chart_pareto_title: 'Analisis Pareto Downtime',
  chart_pareto_sub: 'Analisis kontribusi penyebab terhentinya operasional',
  chart_pareto_duration: 'Durasi (Menit)',
  chart_pareto_frequency: 'Frekuensi',
  chart_pareto_no_data: 'Belum ada data downtime untuk periode ini',
  chart_pareto_bar_duration: 'Durasi Downtime (Menit)',
  chart_pareto_bar_frequency: 'Frekuensi Kejadian (Kali)',
  chart_pareto_line_cum: 'Kumulatif Kontribusi (%)',
  chart_pareto_y_duration: 'Durasi (Menit)',
  chart_pareto_y_frequency: 'Frekuensi (Kali)',
  chart_pareto_y_cum: 'Kumulatif %',

  // Main Dashboard - Operations Overview
  unit_cm_title: 'CM Operations',
  unit_rkc_title: 'RKC Operations',
  unit_view_all: 'LIHAT SEMUA',
  unit_latest_issues: 'Isu Terkini (Downtime)',
  unit_live_feed: 'Live Feed',
  unit_today: 'Hari Ini',
  unit_stopped: 'Pemberhentian Terdeteksi',
  unit_running_normal: 'Operasional Normal',
  unit_no_units: 'Tidak ada unit ditemukan',
  unit_no_active_issues: 'Tidak ada isu downtime aktif.',
  unit_status_run: 'RUN',
  unit_status_stop: 'STOP',
  ...
  cop_parameter_title: 'Parameter COP',
  cop_parameter_subtitle: 'Pemilihan parameter operasi kritis',
  ...
  // Derivative Storage & Trass Warehouse
  trass_material_storage_title: 'Material Storage',
  trass_material_storage_subtitle: 'Pencatatan stok dan ruang isi pada Gudang Penyimpanan Material',
  trass_material_storage_header: 'Material Storage',
  no_trass_storage_data: 'Tidak ada data Material Storage untuk kategori',
  ruang_isi: 'Ruang Isi (m)',

  // WhatsApp Group Report - Derivative
  wag_derivative_title: 'WhatsApp Group Report — Derivative Plant',
  wag_derivative_subtitle:
    'Generate dan format laporan operasional harian Derivative Plant untuk WhatsApp Group',
  wag_report_date: 'Tanggal Laporan',
  wag_select_unit: 'Pilih Unit',
  wag_select_unit_placeholder: 'Pilih unit...',
  wag_units_selected: 'Unit Terpilih',
  wag_select_all: 'PILIH SEMUA',
  wag_clear_all: 'BERSIHKAN',
  wag_processing_report: 'Memproses Laporan...',
  wag_generate_button: 'Generate Laporan WhatsApp',
  wag_preview_title: 'Preview WhatsApp Chat Bubble',
  wag_copy_text: 'Salin Teks',
  wag_copied_text: 'Tersalin!',
  wag_open_web: 'Buka WhatsApp Web',

  // Derivative Master Data
  derivative_master_data_title: 'Derivative Master Data',
  derivative_master_data_subtitle:
    'Kelola data master dan konfigurasi operasional pabrik Derivative',
  import_excel: 'Import Excel',
  importing_excel: 'Mengimpor...',
  export_excel: 'Ekspor Excel',
  exporting_excel: 'Mengekspor...',

  // Derivative Report Page & Common Action Buttons
  processing: 'Memproses...',
  simple_report: 'Laporan Sederhana',
  copying: 'Menyalin...',
  copied: 'Tersalin!',
  copy_image: 'Salin Gambar',
  exporting_pdf: 'Mengekspor PDF...',
  export_pdf: 'Ekspor PDF',
  no_report_generated: 'Belum Ada Laporan Dibuat',
  click_generate_report: 'Klik GENERATE LOG SHEET untuk melihat laporan',
  configure_master_data_hint: 'Harap konfigurasi parameter di Data Master Operasi Pabrik.',
  ...
  project_target_date: 'Target Selesai',
  project_status_label: 'Status Proyek',
  ...
  no_projects_message: 'Belum ada proyek yang terdaftar dalam sistem.',
  ...
  confirm_delete_task_message:
    'Apakah Anda yakin ingin menghapus tugas ini? Tindakan ini tidak dapat dibatalkan.',
  confirm_import: 'Konfirmasi Impor',
  confirm_import_message:
    'Apakah Anda yakin ingin mengimpor {count} tugas? Tindakan ini akan menggantikan seluruh tugas yang ada.',
  add: 'Tambah',
  update: 'Perbarui',
  edit: 'Edit',
  delete: 'Hapus',
  ...
  project_overview_subtitle: 'Wawasan waktu-nyata dan pelacakan kemajuan proyek',
  project_tasks: 'Tugas Proyek',
  project_tasks_list: 'Daftar Tugas Proyek',
  proj_duration: 'Durasi Proyek',
  proj_total_tasks: 'Total Tugas',
  proj_budget: 'Anggaran',
  project_budget: 'Anggaran',
  s_curve_chart_title: 'Grafik Kurva S',
  s_curve_view: 'Kurva S',
  gantt_chart_view: 'Bagan Gantt',
  gantt_view: 'Bagan Gantt',
  ...
  behind_of_schedule: 'Terlambat dari Jadwal',
  on_track_schedule: 'Sesuai Jadwal',
  project_timeline: 'Lini Masa Proyek',
  ...
  add_first_task: 'Tambah Tugas Pertama',
  no_tasks_found: 'Belum Ada Tugas',
  get_started_by_creating_a_task: 'Mulai dengan menambahkan tugas pertama untuk proyek ini.',
  clear_filter_button: 'Hapus Filter',
  active_tasks_header: 'Tugas Aktif:',
  days_label: 'Hari',
  tasks_label: 'Tugas',
  today_marker: 'Hari Ini',
  all_systems_operational: 'Semua sistem operasional normal',
  project_performance_list: 'Daftar Kinerja Proyek',
  health_score: 'Skor Kesehatan',
  baseline_progress: 'Garis Dasar',
  export_error_no_tasks: 'Tidak ada tugas untuk diekspor',
  export_failed: 'Gagal mengekspor data tugas. Silakan coba lagi.',
  // Project Dashboard
  ...
  contractSlaManagement: 'Contract & SLA Management',
  contract_sla_title: 'Contract & SLA Management',
  contract_sla_sub:
    'Monitoring nomor Purchase Order (PO) SAP, masa berlaku H-90, anggaran & serapan volume, serta arsip dokumen digital.',
  po_number: 'Nomor Purchase Order (PO)',
  contract_title: 'Judul Kontrak',
  vendor_name: 'Nama Rekanan / Vendor',
  contract_period: 'Masa Berlaku Kontrak',
  start_date: 'Tanggal Mulai',
  end_date: 'Tanggal Berakhir',
  contract_budget: 'Pagu Anggaran',
  budget_absorbed: 'Serapan Anggaran',
  budget_remaining: 'Sisa Anggaran',
  contract_volume: 'Pagu Volume Kontrak',
  absorbed_volume: 'Realisasi Volume',
  remaining_volume: 'Sisa Volume',
  volume_unit: 'Satuan Volume',
  pic_name: 'Nama PIC / Pengawas',
  pic_contact: 'Kontak PIC / WhatsApp',
  sap_screenshot: 'Screenshot SAP PO',
  contract_pdf: 'Dokumen PDF Kontrak',
  attachments: 'Lampiran Dokumen PDF',
  sla_kpi_target: 'Target & Indikator SLA',
  sla_status: 'Status SLA',
  notes: 'Catatan / Keterangan',
  h90_warning_badge: 'Mendekati Habis (H-90)',
  h30_critical_badge: 'Kritis (H-30)',
  active_badge: 'Aktif',
  expired_badge: 'Kedaluwarsa',
  add_contract: 'Tambah Kontrak Baru',
  edit_contract: 'Edit Data Kontrak',
  delete_contract: 'Hapus Kontrak',
  contract_detail: 'Rincian Kontrak & SLA',
  total_contracts: 'Total Kontrak',
  active_contracts: 'Kontrak Aktif',
  h90_expiring_count: 'Peringatan H-90',
  expired_contracts: 'Kontrak Kedaluwarsa',
  total_managed_budget: 'Pagu Anggaran',
  overall_absorption: 'Serapan Anggaran Total',
  absorbed: 'Terserap',
  remaining: 'Sisa',
  days_remaining: 'Sisa Hari',
  days_left: 'hari lagi',
  days_expired: 'hari yang lalu',
  expired: 'Kedaluwarsa',
  search_contract_placeholder: 'Cari nomor PO, judul kontrak, atau vendor...',
  all_categories: 'Semua Kategori',
  sort_by: 'Urutkan',
  sort_created_desc: 'Terbaru Ditambahkan',
  sort_expiry_asc: 'Masa Berlaku Terdekat',
  sort_budget_desc: 'Nilai Anggaran Tertinggi',
  sort_title_asc: 'Judul Kontrak (A-Z)',
  export_csv: 'Ekspor CSV',
  reset_filters: 'Reset Semua Filter',
  no_contracts_found: 'Tidak ada kontrak yang sesuai dengan filter',
  no_contracts_desc:
    'Silakan ubah kata kunci pencarian atau reset filter untuk melihat data lainnya.',
  preview_pdf: 'Lihat PDF',
  preview_sap: 'Lihat SAP',
  download_file: 'Unduh Berkas',
  open_in_new_tab: 'Buka di Tab Baru',
  zoom_in: 'Perbesar',
  zoom_out: 'Perkecil',
  zoom_reset: 'Reset Ukuran',
  delete_now: 'Hapus Sekarang',
  delete_confirm_title: 'Hapus Data Kontrak?',
  delete_confirm_desc:
    'Anda yakin ingin menghapus data kontrak ini? Tindakan ini tidak dapat dibatalkan.',
  update_realization: 'Update Realisasi',
  update_realization_title: 'Perbarui Realisasi Anggaran & Volume',
  copied_to_clipboard: 'Nomor PO disalin ke clipboard',
  h90_alert_banner_title: 'Perhatian: Kontrak Mendekati Masa Berakhir (H-90 / H-30)',
  view_all_h90: 'Lihat Semua H-90',
  contract_info_tab: 'Informasi Utama',
  contract_budget_tab: 'Anggaran & Volume',
  contract_docs_tab: 'Berkas & Lampiran',
  contract_sla_tab: 'Target SLA & PIC',
  upload_contract_pdf: 'Unggah Dokumen Kontrak (PDF)',
  upload_sap_screenshot: 'Unggah Screenshot SAP PO (Gambar)',
  upload_attachments: 'Unggah Dokumen Lampiran (Multi PDF)',
  drag_drop_pdf: 'Tarik & Lepas berkas PDF Kontrak ke sini, atau klik untuk memilih',
  drag_drop_image: 'Tarik & Lepas tangkapan layar SAP PO ke sini, atau klik untuk memilih',
  drag_drop_attachments: 'Tarik & Lepas beberapa berkas lampiran ke sini, atau klik untuk memilih',
  drop_files_here: 'Lepaskan berkas di sini...',
  click_to_browse: 'Pilih Berkas',
  no_attachments: 'Belum ada dokumen lampiran',
  no_pdf_uploaded: 'Dokumen PDF belum diunggah',
  no_sap_uploaded: 'Screenshot SAP belum diunggah',
  fill_required_fields: 'Harap lengkapi semua kolom wajib (*)',
  need_renewal: 'Perlu Perpanjangan',
  all_secure: 'Status Aman',
  no_expired: 'Tidak ada kedaluwarsa',
  currency: 'Mata Uang Anggaran',
  currency_idr: 'IDR (Rupiah)',
