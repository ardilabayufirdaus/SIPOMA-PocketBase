...
const RISK_DATA_QUERY_KEY = ['rkc-autonomous-risk-data'];
const COLLECTION = 'rkc_autonomous_risk_data';

export const useRkcAutonomousRiskData = () => {
  ...
  // Realtime subscription for rkc_autonomous_risk_data changes
  useEffect(() => {
