...
const CACHE_KEY = CacheKeys.DERIVATIVE_REPORT_SETTINGS || 'derivative_report_settings';
const COLLECTION = 'derivative_report_settings';
const CACHE_TIME = 15; // Minutes

export const useDerivativeReportSettings = () => {
