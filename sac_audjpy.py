...
1. TECHNICAL: Focus on EMA 20/50/200 Trend H4/D1. Ichimoku Cloud (Kumo) is a strong S/R zone. RSI (14) Divergence H4 is valid. MACD zero cross for momentum. ADX > 25 for trend valid. Bollinger Bands (20,2) squeeze indicates imminent breakout.
2. FUNDAMENTAL: AUD (Commodity) vs JPY (Safe-haven). Watch RBA, BoJ, China PMI. VIX index correlation: VIX rises (fear) -> AUDJPY drops.
3. SENTIMENT: Global barometer for Risk-on/Risk-off. Highly volatile. Alignment with AUDUSD and USDJPY direction makes AUDJPY setup stronger.
4. RISK CONTROL: ATR H4 60-120 pip. SL minimum 1.5x ATR. Fibonacci 50%/61.8% are ideal pullback levels. Daily Pivot S1/R1-S2/R2 are respected.
...
def get_tf_indicators(df, tf_id):
    ...
    return {
        ...
        "ema200": ema200, "rsi": rsi, "macd": macd.to_dict(), "adx": adx, 
        "atr": atr, "trend": trend
    }
