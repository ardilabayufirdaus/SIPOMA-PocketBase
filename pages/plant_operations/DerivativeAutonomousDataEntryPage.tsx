...
import { useDerivativeAutonomousRiskData as useAutonomousRiskData } from '../../hooks/useDerivativeAutonomousRiskData';
...
const DerivativeAutonomousDataEntryPage: React.FC<{ t: Record<string, string> }> = ({ t }) => {
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white tracking-tight font-display">
                Derivative {t.op_autonomous_data_entry || 'Autonomous Data Entry'}
              </h1>
              <p className="text-sm text-white/80 font-medium mt-0.5">
                {t.autonomous_data_entry_description ||
                  'Monitor and manage autonomous operations data with real-time tracking (Derivative)'}
              </p>
            </div>
          </div>
        </div>
...
export default DerivativeAutonomousDataEntryPage;
