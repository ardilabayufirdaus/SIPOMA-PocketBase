        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 to-secondary-900 rounded-2xl shadow-xl border border-white/10 p-6">
          ...
          <div className="relative flex items-center gap-4">
            <div className="w-14 h-14 rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center ring-1 ring-white/20 shadow-inner">
              <PresentationChartLineIcon className="w-7 h-7 text-primary-500" />
            </div>
            <div>
        ...
        {filters.plantUnit ? (
          ...
          <div className="bg-white rounded-xl shadow-md border border-slate-200/60 p-8">
            <div className="text-center py-12">
              <div className="w-16 h-16 bg-gradient-to-br from-primary-600 to-emerald-600 rounded-xl mx-auto mb-5 flex items-center justify-center shadow-lg">
