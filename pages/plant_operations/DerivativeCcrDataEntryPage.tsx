      ...
      <div className="relative space-y-6 p-4 lg:p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="relative overflow-hidden bg-slate-900 rounded-2xl shadow-md border border-white/10 p-6">
            ...
            {error && (
              <div className="mt-4 bg-red-50 border border-red-300/50 rounded-xl p-4 shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <button
                      ...
                      className="mt-2 px-3 py-1.5 text-xs font-medium bg-red-100 hover:bg-red-200 text-red-700 rounded-lg"
                    >
                      {t.close_button}
                    </button>
                  </div>
            ...
            <div className="flex flex-wrap items-end gap-4">
              ...
              <div className="flex-1 min-w-[200px]">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#059669]/40 focus:border-[#059669] text-sm font-medium transition-all duration-200 hover:border-slate-300 cursor-pointer"
                  >
              ...
              <div className="flex-1 min-w-[200px]">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#059669]/40 focus:border-[#059669] disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed text-sm font-medium transition-all duration-200 hover:border-slate-300 cursor-pointer"
                  >
              ...
              <div className="flex-1 min-w-[180px]">
                ...
                <div className="relative group/derivative-date">
                  <div className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm font-medium flex items-center justify-between group-hover/derivative-date:border-slate-300 transition-all duration-200">
                    <span>
                      {selectedDate
        ...
        <EnhancedCard className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 space-y-4">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 flex-wrap">
            ...
            {/* Controls Toolbar */}
            <div className="flex flex-col gap-3 w-full lg:w-auto items-end">
              {/* Primary & Visual Controls Row */}
              <div className="flex items-center gap-2 flex-wrap justify-end">
                ...
                <div className="relative group/tooltip">
                  ...
                  >
                    ...
                    <span>{t.refresh_data || 'Refresh'}</span>
                  </button>
                  {lastRefreshTime && (
                    <div className="absolute right-0 top-full mt-2 hidden group-hover/tooltip:block z-50 px-2.5 py-1 text-xs text-white bg-slate-900 rounded-lg shadow-lg whitespace-nowrap">
                ...
                >
                  <span>
                    {isFooterVisible
                      ? t.hide_footer || 'Sembunyikan Footer'
                      : t.show_footer || 'Tampilkan Footer'}
                  </span>
                  {isFooterVisible ? (
                ...
                >
                  ...
                  <span>{t.reorder || 'Urutan Parameter'}</span>
                </button>
                ...
                {(hasPermission('derivative_plant_operations', 'READ') ||
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {(hasPermission('derivative_plant_operations', 'WRITE') ||
                      ...
                      <>
                        ...
                        >
                          ...
                          <span>{t.import || 'Import Excel'}</span>
                        </button>
                      </>
                    )}
                    ...
                    >
                      ...
                      <span>{t.template || 'Template Excel'}</span>
                    </button>
                ...
                {isSuperAdmin(loggedInUser?.role) && (
                  <div className="flex items-center gap-2 ml-2 pl-2 border-l border-slate-200">
                    ...
                    >
                      ...
                      <span>{t.delete_data || 'Hapus Data'}</span>
                    </button>
                    <button
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative ccr-column-search">
                ...
                <input
                  ...
                  className="pl-10 pr-12 py-2 text-sm border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#059669]/50 focus:border-[#059669] transition-all duration-150"
                  style={{ width: '320px' }}
                  autoComplete="off"
            ...
            <div className="flex items-center gap-2">
              ...
              {isSearchActive && (
                <EnhancedButton
                  ...
                  size="xs"
                  onClick={clearColumnSearch}
                  className="text-[#059669] hover:text-[#047857] transition-colors font-medium"
            ...
            >
              ...
              <div className="ccr-table-wrapper min-w-[800px]" ref={tableWrapperRef}>
                ...
                >
                  ...
                  <thead
                    className="bg-slate-800 text-white text-center sticky top-0 z-20 shadow-sm border-b-2 border-slate-700"
                    role="rowgroup"
                  >
                    <tr className="border-b border-slate-700" role="row">
                      <th
                        className="px-2 py-3 text-center text-xs font-bold text-white uppercase tracking-wider border-r border-slate-700 sticky left-0 bg-slate-900 z-30 sticky-col-header shadow-sm"
                        style={{ width: '60px' }}
                        role="columnheader"
                        scope="col"
                      >
                      ...
                      <th
                        className="px-2 py-3 text-center text-xs font-bold text-white uppercase tracking-wider border-r border-slate-700 bg-slate-900"
                        style={{ width: '80px' }}
                        role="columnheader"
                        scope="col"
                      >
                      ...
                      <th
                        className="px-3 py-3 text-center text-xs font-bold text-white uppercase tracking-wider border-r border-slate-700 bg-slate-900"
                      ...
                      {filteredParameterSettings.map((param) => (
                        <th
                          key={param.id}
                          className={`px-2 py-3 text-xs font-bold border-r border-slate-700 text-center bg-slate-800 text-white ${
                                ...
                                if (isSuperAdmin(loggedInUser?.role)) {
                                  return (
                                    <input
                                      ...
                                      className="w-full px-2 py-1 text-xs border border-neutral-300 rounded focus:ring-1 focus:ring-neutral-400 bg-white hover:bg-neutral-50 text-neutral-800"
                                ...
                                <div className="relative">
                                  {isProductTypeParameter ? (
                                    <select
                                      ...
                                      disabled={!canWrite}
                                      className={`w-full text-center text-sm px-2 py-2 border ${cellBorderClass} rounded focus:ring-1 focus:ring-neutral-400 bg-white dark:bg-slate-800 ${cellTextClass} ${
                                    ...
                                    <input
                                      ...
                                      disabled={!canWrite}
                                      className={`w-full text-center text-xs px-1 border ${cellBorderClass} rounded focus:ring-1 focus:ring-neutral-400 bg-transparent ${cellTextClass} ${
                                        isCurrentlySaving ? 'opacity-50 cursor-not-allowed' : ''
                                      }`}
                                      style={{
                                        fontSize: '12px',
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-slate-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-[#059669]/50 focus:border-[#059669] resize-vertical bg-white disabled:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200"
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <button
                    ...
                    className="h-9 px-3.5 bg-[#059669] hover:bg-[#047857] text-white rounded-xl text-xs font-semibold shadow-sm transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 whitespace-nowrap shrink-0"
                    title={t.add_downtime_button || 'Tambah Downtime'}
                  >
                    <PlusIcon className="w-4 h-4 text-white" />
                    <span>{t.add_downtime_button || 'Tambah Downtime'}</span>
                  </button>
                </div>
              </div>
            ...
            <div className="flex justify-end gap-3 pt-4 border-t flex-wrap">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-slate-700 bg-white border border-slate-300 rounded-xl hover:bg-slate-50 transition-all duration-200"
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-white bg-[#059669] hover:bg-[#047857] rounded-xl transition-all duration-200 shadow-sm"
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-[#059669] hover:bg-[#047857] rounded-xl transition-all duration-200 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                aria-label={t.save_profile}
              >
                {t.save_profile}
              </button>
            </div>
        ...
        >
          ...
          <div className="bg-neutral-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse rounded-b-lg gap-2">
            <button
              ...
              className="sm:ml-3 sm:w-auto w-full px-4 py-2 bg-[#C7162B] hover:bg-[#9e1122] text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-sm"
            ...
            <button
              ...
              className="mt-2 sm:mt-0 sm:w-auto w-full px-4 py-2 bg-white border border-slate-300 text-slate-700 hover:bg-slate-50 text-sm font-semibold rounded-xl transition-all duration-200"
