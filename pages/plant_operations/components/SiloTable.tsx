        ...
        <table className="w-full text-[6px] min-w-max">
          <thead>
            ...
            <tr className="bg-gradient-to-r from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30">
              <th
                rowSpan={2}
                className="px-1 py-1 text-left font-bold text-slate-800 dark:text-slate-200 border-r border-emerald-200 dark:border-emerald-700 sticky left-0 bg-inherit z-10 min-w-24 align-middle text-[6px]"
              >
                {t.silo_name || 'Silo Name'}
              </th>
              <th
                colSpan={3}
                className="px-1 py-1 text-center font-semibold text-slate-800 dark:text-slate-200 border-r border-slate-200 dark:border-slate-600 align-middle text-[6px]"
              >
                {t.shift_1 || 'Shift 1'}
              </th>
              <th
              ...
              <th
                colSpan={3}
                className="px-1 py-1 text-center font-semibold text-slate-800 dark:text-slate-200 align-middle text-[6px]"
              >
                {t.shift_3 || 'Shift 3'}
              </th>
            </tr>
          ...
          <tbody>
            {siloData.map((silo, index) => (
              ...
              >
                <td className="px-1 py-1 font-medium text-slate-900 dark:text-slate-100 border-r border-slate-200 dark:border-slate-600 sticky left-0 bg-inherit z-10 align-middle text-[6px]">
                ...
                {['shift1', 'shift2', 'shift3'].map((shiftKey, shiftIndex) => {
                  ...
                  return (
                    <React.Fragment key={shiftKey}>
                      <td className="px-1 py-1 text-center text-slate-800 dark:text-slate-200 border-r border-slate-200 dark:border-slate-600 align-middle text-[6px]">
                      ...
                      <td
                        className={`px-1 py-1 text-center text-slate-800 dark:text-slate-200 align-middle text-[6px] ${
