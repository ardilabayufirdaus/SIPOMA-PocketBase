        ...
        >
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden h-full">
            <div className="px-8 py-6 border-b border-slate-200/50 bg-gradient-to-r from-slate-900 to-secondary-900">
              ...
              <p className="text-sm text-slate-300 mt-2">Real-time data for {filters.date}</p>
            </div>

            <div className="overflow-x-auto overflow-y-auto max-h-[480px]">
              <table className="w-full">
                <thead className="bg-slate-600 dark:bg-slate-700 sticky top-0">
                  <tr>
                ...
                <tfoot className="bg-slate-50 border-t-2 border-slate-300">
                  <tr>
                    ...
                    <td className="px-6 py-4 text-sm font-bold text-primary-600 bg-emerald-100 rounded-lg mx-2">
