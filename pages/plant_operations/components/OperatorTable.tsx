        ...
        <table className="w-full text-[6px] min-w-0">
          <thead>
            <tr className="bg-gradient-to-r from-blue-100 to-cyan-100">
              ...
              <th className="px-1 py-1 text-left font-bold text-slate-800 align-middle text-[6px]">
                {t.name}
              </th>
            </tr>
          </thead>
          <tbody>
            {operatorData.map((operator, index) => (
              ...
              >
                ...
                <td className="px-1 py-1 text-slate-800 align-middle font-medium text-[6px]">
                  {operator.name}
                </td>
              </motion.tr>
            ))}
