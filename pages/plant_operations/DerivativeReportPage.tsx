        ...
        <div className="flex flex-wrap items-end gap-6">
          ...
          <div className="flex items-end gap-3 flex-shrink-0 ml-auto">
            <EnhancedButton
              ...
              variant="ghost"
              size="sm"
              className="px-6 py-2.5 h-[42px] text-sm font-bold !bg-[#059669] hover:!bg-[#047857] !text-white shadow-md hover:shadow-lg transition-all !border-0 rounded-xl tracking-wide disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <EnhancedButton
              ...
              variant="ghost"
              size="sm"
              className="px-6 py-2.5 h-[42px] text-sm font-bold !border-2 !border-[#059669] !text-[#059669] hover:!bg-[#059669]/10 rounded-xl tracking-wide disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            {reportData && (
              <>
                ...
                <EnhancedButton
                  ...
                  variant="secondary"
                  size="sm"
                  className={`px-4 py-2.5 h-[42px] text-sm font-bold shadow-md hover:shadow-lg transition-all rounded-xl border-0 disabled:opacity-50 disabled:cursor-not-allowed ${
                    copySuccess
                ...
                <EnhancedButton
                  ...
                  variant="secondary"
                  size="sm"
                  className="px-4 py-2.5 h-[42px] text-sm font-bold bg-slate-800 hover:bg-slate-900 text-white shadow-md hover:shadow-lg transition-all rounded-xl border-0 disabled:opacity-50 disabled:cursor-not-allowed"
