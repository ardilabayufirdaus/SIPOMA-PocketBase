...
const HoseValveBlastingMBFTab: React.FC<TabComponentProps> = ({ language }) => {
  ...
  const renderHopperTable = (hopperName: string) => (
    <div key={hopperName} className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      {/* Hopper Header */}
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-3 py-3 text-left font-medium text-gray-900 border-r border-gray-200">
              ...
              <th className="px-3 py-3 text-left font-medium text-gray-900">Ket</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-200">
            {formData.hoppers[hopperName].map((row, index) => (
              <tr key={index} className="hover:bg-gray-50">
                <td className="px-3 py-2 text-center font-medium text-gray-900 border-r border-gray-200">
                  {row.urutan}
                </td>
    ...
    <div className="space-y-6 max-w-full">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Tender</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">CP Personil EPDC</label>
  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex items-center">
        <ClipboardCheckIcon className="w-6 h-6 mr-2 text-primary-600" />
        <h1 className="text-2xl font-bold text-gray-900">
          {language === 'en' ? 'New Inspection' : 'Inspeksi Baru'}
        </h1>
      </div>

      <EnhancedCard className="bg-white rounded-lg shadow">
        {/* Tab Navigation */}
